...
if TYPE_CHECKING:
    ...
    from eserv.types import Config
...
def upload_documents(
    ...
    *,
    ...
    bound_args = inspect.signature(UploadResult).bind_partial(
        status=state,
        folder_path=target,
    ...
    return UploadResult(*bound_args.args, **bound_args.kwargs)
