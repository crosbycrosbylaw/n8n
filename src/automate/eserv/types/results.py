...
__all__ = ['BatchResult', 'IntermediaryResult', 'ProcessedResult']
...
if TYPE_CHECKING:
    ...
    from automate.eserv.types import CaseMatch
    from automate.eserv.types.enums import UploadStatus
    from automate.eserv.types.structs import EmailInfo
    from automate.eserv.types.typechecking import ErrorDict, ProcessedResultDict, ProcessStatus


@dataclass(slots=True, frozen=True)
class IntermediaryResult:
    """Result of a document processing pipeline operation.
...
class ProcessedResult:
    ...
    def asdict(self) -> ProcessedResultDict:
        ...
        out.update((key, getattr(self.record, key, '')) for key in ('uid', 'sender', 'subject'))
